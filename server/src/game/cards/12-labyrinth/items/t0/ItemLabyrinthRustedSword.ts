...
export default class ItemLabyrinthRustedSword extends ServerCard {
	baseDamage = asDirectSpellDamage(1)
	...
	constructor(game: ServerGame) {
		super(game, {
			...
			features: [CardFeature.HERO_POWER, CardFeature.LABYRINTH_ITEM_T0],
			stats: {
				cost: 1,
			},
