...
const asScalingStat = (value: number, mapper: (unit: ServerUnit) => number): LeaderStatValueGetter => {
...
export const asDirectUnitDamage = (baseDamage: number): LeaderStatValueGetter => {
	return asScalingStat(baseDamage, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.DIRECT_UNIT_DAMAGE))
}

export const asSplashUnitDamage = (baseDamage: number): LeaderStatValueGetter => {
	return asScalingStat(baseDamage, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.SPLASH_UNIT_DAMAGE))
}

export const asDirectSpellDamage = (baseDamage: number): LeaderStatValueGetter => {
	return asScalingStat(baseDamage, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.DIRECT_SPELL_DAMAGE))
}

export const asSplashSpellDamage = (baseDamage: number): LeaderStatValueGetter => {
	return asScalingStat(baseDamage, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.SPLASH_SPELL_DAMAGE))
}

export const asDirectHealingPotency = (potency: number): LeaderStatValueGetter => {
	return asScalingStat(potency, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.DIRECT_HEALING_POTENCY))
}

export const asSplashHealingPotency = (potency: number): LeaderStatValueGetter => {
	return asScalingStat(potency, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.SPLASH_HEALING_POTENCY))
}

export const asRecurringHealingPotency = (potency: number): LeaderStatValueGetter => {
	return asScalingStat(potency, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.RECURRING_HEALING_POTENCY))
}

export const asDirectBuffPotency = (potency: number): LeaderStatValueGetter => {
	return asScalingStat(potency, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.DIRECT_BUFF_POTENCY))
}

export const asSplashBuffPotency = (potency: number): LeaderStatValueGetter => {
	return asScalingStat(potency, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.SPLASH_BUFF_POTENCY))
}

export const asRecurringBuffPotency = (potency: number): LeaderStatValueGetter => {
	return asScalingStat(potency, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.RECURRING_BUFF_POTENCY))
}

export const asDirectEffectDuration = (duration: number): LeaderStatValueGetter => {
	return asScalingStat(duration, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.DIRECT_EFFECT_DURATION))
}

export const asSplashEffectDuration = (duration: number): LeaderStatValueGetter => {
	return asScalingStat(duration, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.SPLASH_EFFECT_DURATION))
}

export const asTargetCount = (count: number): LeaderStatValueGetter => {
	return asScalingStat(count, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.DIRECT_TARGET_COUNT))
}

export const asCriticalDamageChance = (value: number): LeaderStatValueGetter => {
	return asScalingStat(value, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.CRITICAL_DAMAGE_CHANCE))
}

export const asCriticalBuffChance = (value: number): LeaderStatValueGetter => {
	return asScalingStat(value, (unit) => unit.card.stats.getLeaderStat(LeaderStatType.CRITICAL_BUFF_CHANCE))
}
...
export const asDirectSparkDamage = (value: number): LeaderStatValueGetter => {
	return asScalingStat(value, (unit) => unit.card.stats.getLeaderStats([LeaderStatType.DIRECT_SPELL_DAMAGE, LeaderStatType.SPARK_DAMAGE]))
}

export const asSplashSparkDamage = (value: number): LeaderStatValueGetter => {
	return asScalingStat(value, (unit) => unit.card.stats.getLeaderStats([LeaderStatType.SPLASH_SPELL_DAMAGE, LeaderStatType.SPARK_DAMAGE]))
}
