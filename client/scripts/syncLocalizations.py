...
with open('../src/Pixi/locales/en.json', 'r', encoding='utf-8') as f:
	json_en_text = f.read()

with open('../src/Pixi/locales/ru.json', 'r', encoding='utf-8') as f:
	json_ru_text = f.read()
...
with open('../src/Pixi/locales/ru.json', 'w', encoding='utf-8') as f:
	f.write(finalJson)
