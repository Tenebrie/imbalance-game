<template>
	<div class="slider" @focus="onFocusReceived" @mousedown="this.onMouseDown" ref="sliderRef" tabindex="0" @keydown="this.onKeyDown" :class="showOutlineClass">
...
export default {
	...
	computed: {
		...
		showOutlineClass(): Record<string, string> {
			return {
				'show-outline': this.showOutline
			}
		}
	}
}
